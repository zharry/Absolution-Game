...
public class GameObjectAssets {
	...
	public static void initSprites() {
		...
		try {
			...
			sprPlayer[1][i = 0] = ImageIO.read(new File(PLAYERDIR + "R1.png"));
			sprPlayer[1][i++] = ImageIO.read(new File(PLAYERDIR + "R1.png"));
			sprPlayer[1][i++] = ImageIO.read(new File(PLAYERDIR + "R1.png"));
			sprPlayer[1][i++] = ImageIO.read(new File(PLAYERDIR + "R1.png"));
			sprPlayer[2][i = 0] = ImageIO.read(new File(PLAYERDIR + "F1.png"));
			...
			sprPlayer[3][i = 0] = ImageIO.read(new File(PLAYERDIR + "L1.png"));
